...
export function TransactionForm(params = {}) {
  ...
  function subcategoryFieldHtml() {
    ...
    return `
      <div class="form-group" style="margin-top: var(--sp-4)" id="subcat-group">
        <label class="form-label" for="f-subcategory">${icons.inbox}Sous-catégorie <span class="optional">(optionnel)</span></label>
    ...
    if (selectedType === 'transfer') {
      return `
        <div class="form-group" style="margin-top: var(--sp-4)">
          <label class="form-label" for="f-to-account">${icons.bank}Vers le compte</label>
  ...
  function accountFieldHtml() {
    const label = `${icons.bank}${selectedType === 'transfer' ? 'Depuis le compte' : 'Compte'}`;
  ...
  screen.innerHTML = `
    <form id="tx-form" novalidate>
      ...
      <div class="form-group" style="margin-top: var(--sp-4)">
        <label class="form-label" for="f-amount">${icons.cash}Montant (MGA)</label>
      ...
      <div class="form-group" style="margin-top: var(--sp-4)">
        <label class="form-label" for="f-note">${icons.notes}Note <span class="optional">(optionnel)</span></label>
        <input class="form-input" id="f-note" name="note" placeholder="Ex. Courses de la semaine" value="${existing?.note ?? ''}" />
      </div>

      <div class="form-group" style="margin-top: var(--sp-4)">
        <label class="form-label" for="f-date">${icons.calendar}Date</label>
