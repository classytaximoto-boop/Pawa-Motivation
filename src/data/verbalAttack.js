...
export const verbalSituations = [
  ...
  },
  {
    id: 'v38',
    category: 'drague',
    title: 'Un rendez-vous tombe pile sur un engagement personnel important',
    context: 'Tu dois choisir entre repousser un objectif perso ou décaler le rendez-vous.',
    responses: {
      sigma: ["Je préfère décaler, j'ai un truc important ce jour-là.", "On peut trouver un autre moment ? Celui-ci ne me va pas."],
      alpha: ["Je tiens à mes engagements, on se voit un autre jour.", "Ce jour-là c'est non, mais je suis partant pour un autre créneau."],
      charisme: ["Mon planning est aussi sérieux que mes intentions, on trouve un autre jour ?", "Je décale, pas par désintérêt, juste par organisation."],
      confiant: ["Mes objectifs restent ma priorité, ça n'empêche pas qu'on se voie autrement.", "Je propose un autre jour, ça me tient à cœur de te voir dans de bonnes conditions."],
    },
  },
  {
    id: 'v39',
    category: 'drague',
    title: 'Tu attends un retour ou une validation de la personne qui te plaît',
    context: 'Tu te surprends à guetter une réponse, un like, un signe.',
    responses: {
      sigma: ["Je continue ma journée, sa réponse viendra ou pas.", "Je ne vis pas suspendu à son téléphone."],
      alpha: ["Je ne dépends pas de sa réponse pour aller bien.", "J'avance, avec ou sans retour de sa part."],
      charisme: ["Mon humeur du jour ne se décide pas via un écran.", "Je fais autre chose, la validation peut attendre."],
      confiant: ["Je suis bien avec moi-même, son message arrivera quand il arrivera.", "Je m'intéresse à elle/lui sans que ça définisse ma valeur."],
    },
  },
  {
    id: 'v40',
    category: 'drague',
    title: 'La personne semble vouloir provoquer une réaction de jalousie',
    context: 'Elle mentionne un autre prétendant ou compare volontairement.',
    responses: {
      sigma: ["Ok, je note. Ça ne change rien pour moi.", "Chacun voit qui il veut, je reste tranquille."],
      alpha: ["Je ne rentre pas dans ce jeu de comparaison.", "Si c'est un test, il ne marche pas sur moi."],
      charisme: ["Content pour toi, ça ne perturbe pas ma soirée.", "Intéressant, mais ça ne me fait ni chaud ni froid."],
      confiant: ["Je te fais confiance, la jalousie ne m'intéresse pas comme jeu.", "Je reste concentré sur ce qui est vrai entre nous, pas sur les comparaisons."],
    },
  },
...
export const peopleTypes = [
  {
    ...
    tip: 'Approche calmement et de face, jamais par-derrière ou en bloquant le passage — ça évite de faire peur. Accepte dès le départ qu\'un refus est possible, et ne t\'accroche pas à sa validation : sois toi-même, avec une vraie question ou remarque, pas une réplique préparée à l\'excès.',
    phrases: {
