...
export function MoneyHome() {
  ...
  screen.innerHTML = `
    <div class="screen-title-row">
      <h1>Money</h1>
      <button type="button" class="chip" id="goto-accounts-btn">${icons.bank}Comptes</button>
      <button type="button" class="chip" id="goto-categories-btn">${icons.sliders}Catégories</button>
      <button type="button" class="chip" id="goto-debts-btn">${icons.handshakeOut}Dettes</button>
      <button type="button" class="chip" id="goto-scheduled-btn">${icons.calendar}Planifiés</button>
      <button type="button" class="chip" id="goto-wallet-settings-btn">${icons.sliders}Paramètres</button>
    </div>
