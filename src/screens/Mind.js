...
function sliderRow({ id, label, value }) {
  return `
    <div class="mind-slider-row">
      ...
      <input class="mind-slider" type="range" min="0" max="10" step="1" id="${id}" value="${value}" />
    </div>`;
}
  ...
  screen.innerHTML = `
    <form id="emotion-form" novalidate>
      ...
      <div class="card" style="margin-top: var(--sp-4)">
        ...
        ${sliderRow({ id: 'f-intensity', label: 'Intensité de l’émotion', value: 5 })}
      </div>
...
export function Mind() {
  ...
  tabs.innerHTML = `
    ...
    <button class="tab-btn" id="mind-ressenti-tab" style="color:var(--ember-400)">Ce que je ressens →</button>
    <button class="tab-btn" id="mind-dev-tab" style="color:var(--ember-400)">Développement →</button>
  `;
  el.appendChild(tabs);
  ...
  tabs.querySelector('#mind-ressenti-tab').addEventListener('click', () => router.navigate('/ressenti'));
  tabs.querySelector('#mind-dev-tab').addEventListener('click', () => router.navigate('/developpement'));
