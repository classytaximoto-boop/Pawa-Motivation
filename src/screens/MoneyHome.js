...
export function MoneyHome() {
  ...
  screen.innerHTML = `
    <div class="screen-title-row">
      ...
      <button type="button" class="chip" id="goto-stats-btn">${icons.barChart}Statistiques</button>
    </div>
  ...
  screen.querySelector('#goto-stats-btn').addEventListener('click', () => router.navigate('/money/statistiques'));
