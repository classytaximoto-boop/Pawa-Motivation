    ...
    formCard.innerHTML = `
      ...
      <form id="shop-form" novalidate>
        <div class="form-group">
          <label class="form-label" for="f-shop-name">Nom</label>
        ...
        <div class="form-group" style="margin-top:var(--sp-3);display:flex;gap:var(--sp-3)">
          <div style="flex:1">
            <label class="form-label" for="f-shop-qty">Quantité</label>
            <input class="form-input" type="number" min="1" id="f-shop-qty" name="quantity" value="${editingItem?.quantity ?? 1}" />
          </div>
          <div style="flex:2">
            <label class="form-label" for="f-shop-price">Prix estimé (MGA)</label>
        ...
        <div class="form-group" style="margin-top:var(--sp-3)">
          <label class="form-label" for="f-shop-notes">Notes</label>
