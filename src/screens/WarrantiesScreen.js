  ...
  wrap.innerHTML = `
    ...
    <section class="card" style="margin-top:var(--sp-3)">
      ...
      <div class="detail-meta-grid" style="margin-top:var(--sp-3)">
        <div class="detail-meta-item"><span class="detail-meta-item__label">Catégorie</span><span class="detail-meta-item__value">${w.category || '—'}</span></div>
        <div class="detail-meta-item"><span class="detail-meta-item__label">Vendeur</span><span class="detail-meta-item__value">${w.seller || '—'}</span></div>
        <div class="detail-meta-item"><span class="detail-meta-item__label">Prix d'achat</span><span class="detail-meta-item__value mono">${fmtAmount(w.purchasePrice)}</span></div>
        <div class="detail-meta-item"><span class="detail-meta-item__label">Date d'achat</span><span class="detail-meta-item__value">${fmtDate(w.purchaseDate, { day: '2-digit', month: 'long', year: 'numeric' })}</span></div>
        <div class="detail-meta-item"><span class="detail-meta-item__label">Expiration</span><span class="detail-meta-item__value">${w.expiryDate ? fmtDate(w.expiryDate, { day: '2-digit', month: 'long', year: 'numeric' }) : '—'}</span></div>
        <div class="detail-meta-item"><span class="detail-meta-item__label">Temps restant</span><span class="detail-meta-item__value" style="color:var(${colorVar})">${daysLeftLabel(w)}</span></div>
        <div class="detail-meta-item"><span class="detail-meta-item__label">Référence</span><span class="detail-meta-item__value">${w.reference || '—'}</span></div>
      </div>
...
export function WarrantiesScreen() {
  ...
  summaryCard.innerHTML = `
    <div class="detail-meta-grid">
      <div class="detail-meta-item"><span class="detail-meta-item__label">Total</span><span class="detail-meta-item__value mono">${summary.total}</span></div>
      <div class="detail-meta-item"><span class="detail-meta-item__label">Actives</span><span class="detail-meta-item__value mono" style="color:var(--success-500)">${summary.active}</span></div>
      <div class="detail-meta-item"><span class="detail-meta-item__label">Expire bientôt</span><span class="detail-meta-item__value mono" style="color:var(--warning-500)">${summary.expiringSoon}</span></div>
      <div class="detail-meta-item"><span class="detail-meta-item__label">Expirées</span><span class="detail-meta-item__value mono" style="color:var(--danger-500)">${summary.expired}</span></div>
    </div>
  `;
    ...
    formCard.innerHTML = `
      ...
      <form id="war-form" novalidate>
        <div class="form-group">
          <label class="form-label" for="f-war-product">Produit</label>
        ...
        <div class="form-group" style="margin-top:var(--sp-3)">
          <label class="form-label" for="f-war-category">Catégorie</label>
        ...
        <div class="form-group" style="margin-top:var(--sp-3);display:flex;gap:var(--sp-3)">
          <div style="flex:1">
            <label class="form-label" for="f-war-purchase-date">Date d'achat</label>
          ...
          <div style="flex:1">
            <label class="form-label" for="f-war-price">Prix d'achat (MGA)</label>
        ...
        <div class="form-group" style="margin-top:var(--sp-3)">
          <label class="form-label" for="f-war-notes">Notes</label>
