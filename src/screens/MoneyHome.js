...
export function MoneyHome() {
  ...
  screen.innerHTML = `
    ...
    <div class="money-quicklinks-row">
      <button type="button" class="chip money-quicklink" id="goto-accounts-btn">${icons.bank}<span>Comptes</span></button>
      <button type="button" class="chip money-quicklink" id="goto-categories-btn">${icons.sliders}<span>Catégories</span></button>
      <button type="button" class="chip money-quicklink" id="goto-debts-btn">${icons.handshakeOut}<span>Dettes</span></button>
      <button type="button" class="chip money-quicklink" id="goto-scheduled-btn">${icons.calendar}<span>Planifiés</span></button>
      <button type="button" class="chip money-quicklink" id="goto-wallet-settings-btn">${icons.sliders}<span>Paramètres</span></button>
    </div>
  ...
  screen.querySelector('#goto-accounts-btn').addEventListener('click', () => router.navigate('/money/comptes'));
  screen.querySelector('#goto-categories-btn').addEventListener('click', () => router.navigate('/money/categories'));
  screen.querySelector('#goto-debts-btn').addEventListener('click', () => router.navigate('/money/dettes'));
  screen.querySelector('#goto-scheduled-btn').addEventListener('click', () => router.navigate('/money/paiements-planifies'));
  screen.querySelector('#goto-wallet-settings-btn').addEventListener('click', () => router.navigate('/money/parametres'));
