 ...
 * "Compétences" de Développement, sous la liste des compétences déjà
 * suivies par l'utilisateur.
 *
 * Les domaines (id/label) sont volontairement alignés 1:1 sur
 * `skillCategories` de `data/personalDev.js`, pour que la section
 * "à apprendre" et la section "mes compétences" utilisent le même
 * vocabulaire de catégories (technique, business, relationnel,
 * juridique, langue, autre).
 */
...
export const learningDomains = [
  ...
  {
    id: 'juridique',
    label: 'Juridique / droits',
    icon: '⚖️',
    skills: [
      {
        name: 'Bases du droit du travail malgache',
        desc: 'Connaître ses droits de base en tant que salarié ou indépendant.',
        pistes: ['Lire le Code du travail malgache (grandes lignes)', 'Connaître la procédure en cas de litige employeur', 'Voir l\'onglet "Droits" de cette app pour les scénarios pratiques'],
      },
      {
        name: 'Droits face aux autorités',
        desc: 'Savoir ce qui est légal et exigible lors d\'un contrôle.',
        pistes: ['Relire les scénarios de l\'onglet Droits', 'Connaître les documents à toujours avoir sur soi', 'Savoir formuler une demande calmement et clairement'],
      },
      {
        name: 'Bases contractuelles',
        desc: 'Lire et comprendre un contrat avant de signer (prestation, location, etc.).',
        pistes: ['Identifier les clauses de résiliation avant de signer', 'Vérifier systématiquement les montants et délais', 'Demander une clarification écrite en cas de doute'],
      },
    ],
  },
  {
  ...
  },
  {
    ...
    skills: [
      ...
      {
        name: 'Créativité / génération d\'idées',
        desc: 'Sortir des sentiers battus sur un projet bloqué.',
        pistes: ['Brainstorm sans jugement pendant 10 min avant de trier', 'Changer d\'environnement pour débloquer une idée', 'Noter toutes les idées, même les mauvaises, avant de choisir'],
      },
      {
        name: 'Géopolitique',
        desc: 'Comprendre les grands rapports de force entre pays, régions et acteurs mondiaux — pour analyser l\'actualité au-delà des titres.',
        pistes: ['Choisir une zone (Océan Indien, Afrique australe, grandes puissances) et suivre son actualité chaque semaine', 'Comparer 2-3 sources différentes sur un même événement avant de se faire un avis', 'Repérer les intérêts économiques et stratégiques derrière chaque conflit ou accord'],
      },
      {
        name: 'Fact-checking / esprit critique',
        desc: 'Vérifier une information avant de la croire ou de la partager.',
        pistes: ['Remonter systématiquement à la source primaire d\'une info', 'Vérifier la date de publication (une vieille info recyclée trompe souvent)', 'Se méfier des titres qui provoquent une émotion forte — vérifier avant de réagir', 'Croiser au moins deux sources indépendantes avant de considérer un fait comme établi'],
      },
      {
        name: 'Comprendre la nature d\'un problème',
        desc: 'Aller au-delà du symptôme pour identifier la cause réelle d\'une situation, avant de chercher une solution.',
        pistes: ['Se demander "pourquoi" cinq fois de suite face à un problème', 'Séparer les faits observables des interprétations qu\'on en fait', 'Distinguer la cause immédiate de la cause profonde avant d\'agir'],
      },
      {
        name: 'Intelligence (raisonnement, mémoire, logique)',
        desc: 'Muscler ses capacités de réflexion, pas seulement accumuler des connaissances.',
        pistes: ['Pratiquer des exercices de logique ou d\'échecs régulièrement', 'Apprendre une technique de mémorisation (méthode des lieux, répétition espacée)', 'Résoudre un problème inconnu sans chercher la solution immédiatement — tolérer l\'inconfort de ne pas savoir'],
      },
    ],
  },
];
