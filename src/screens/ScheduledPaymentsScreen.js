...
function subcategoryFieldHtml() {
  ...
  return `
    <div class="form-group" style="margin-top: var(--sp-4)" id="subcat-group">
      <label class="form-label" for="f-sp-subcategory">Sous-catégorie <span class="optional">(optionnel)</span></label>
  ...
  return `
    <form id="sp-form" class="card" style="margin-bottom:var(--sp-3)" novalidate>
      <div class="form-group">
        <label class="form-label" for="f-sp-name">Nom</label>
      ...
      <div class="form-group" style="margin-top: var(--sp-4)">
        <label class="form-label" for="f-sp-due">Prochaine échéance</label>
      ...
      <div class="form-group" style="margin-top: var(--sp-4)">
        <label class="form-label" for="f-sp-reminder">Rappel <span class="optional">(jours avant l'échéance)</span></label>
...
function historyBlock(payment) {
  ...
  block.innerHTML = `
    <div class="detail-section-title">Historique des confirmations</div>
...
export function ScheduledPaymentsScreen() {
  ...
  screen.innerHTML = `
    ...
    <section class="card" style="border-color:var(--danger-500)">
      <div class="detail-section-title" style="color:var(--danger-500)">${duePayments.length} paiement(s) à confirmer</div>
