...
export function StatisticsScreen() {
  ...
  overviewCard.innerHTML = `
    <div class="progress-header">
      <span class="progress-header__title">Solde</span>
    ...
    <div class="detail-meta-grid" style="margin-top:var(--sp-3)">
      ...
      <div class="detail-meta-item">
        <span class="detail-meta-item__label">Épargne (période)</span>
        <span class="detail-meta-item__value mono" style="color:var(--success-500)">${fmtAmount(savings)}</span>
      </div>
      <div class="detail-meta-item">
        <span class="detail-meta-item__label">Transactions</span>
  ...
  evolutionCard.innerHTML = `
    <div class="detail-section-title">Évolution entrées / sorties</div>
    <div style="margin-top:var(--sp-2)">
  ...
  budgetCard.innerHTML = `
    <div class="detail-section-title">Budgets (mois en cours)</div>
    <div style="margin-top:var(--sp-2)">
  ...
  debtsCard.innerHTML = `
    <div class="detail-section-title">Dettes</div>
    <div class="detail-meta-grid" style="margin-top:var(--sp-2)">
      <div class="detail-meta-item"><span class="detail-meta-item__label">Prêté (restant dû)</span><span class="detail-meta-item__value mono">${fmtAmount(debtsSummary.totalLent)}</span></div>
      <div class="detail-meta-item"><span class="detail-meta-item__label">Emprunté (restant dû)</span><span class="detail-meta-item__value mono">${fmtAmount(debtsSummary.totalBorrowed)}</span></div>
      <div class="detail-meta-item"><span class="detail-meta-item__label">En retard</span><span class="detail-meta-item__value mono" style="color:${debtsSummary.lateCount > 0 ? 'var(--danger-500)' : 'var(--text-primary)'}">${debtsSummary.lateCount}</span></div>
      <div class="detail-meta-item"><span class="detail-meta-item__label">Total dettes</span><span class="detail-meta-item__value mono">${debts.length}</span></div>
    </div>
  `;
  ...
  goalsCard.innerHTML = `
    <div class="detail-section-title">Objectifs financiers</div>
    <div class="detail-meta-grid" style="margin-top:var(--sp-2)">
      <div class="detail-meta-item"><span class="detail-meta-item__label">Actifs</span><span class="detail-meta-item__value mono">${activeGoals.length}</span></div>
      <div class="detail-meta-item"><span class="detail-meta-item__label">Atteints</span><span class="detail-meta-item__value mono" style="color:var(--success-500)">${completedGoals.length}</span></div>
    </div>
  ...
  invCard.innerHTML = `
    <div class="detail-section-title">Investissements</div>
    <div class="detail-meta-grid" style="margin-top:var(--sp-2)">
      <div class="detail-meta-item"><span class="detail-meta-item__label">Capital total</span><span class="detail-meta-item__value mono">${fmtAmount(investmentsSummary.totalInitial)}</span></div>
      <div class="detail-meta-item"><span class="detail-meta-item__label">Valeur actuelle</span><span class="detail-meta-item__value mono">${fmtAmount(investmentsSummary.totalCurrent)}</span></div>
      <div class="detail-meta-item"><span class="detail-meta-item__label">Gain/Perte</span><span class="detail-meta-item__value mono" style="color:${performanceColor(investmentsSummary.totalGain)}">${investmentsSummary.totalGain >= 0 ? '+' : ''}${fmtAmount(investmentsSummary.totalGain)}</span></div>
      <div class="detail-meta-item"><span class="detail-meta-item__label">Performance globale</span><span class="detail-meta-item__value mono" style="color:${performanceColor(investmentsSummary.globalPerformance)}">${investmentsSummary.globalPerformance >= 0 ? '+' : ''}${Math.round(investmentsSummary.globalPerformance * 10) / 10}%</span></div>
    </div>
